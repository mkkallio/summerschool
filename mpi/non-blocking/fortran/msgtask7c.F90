program basic
  ...
  !       sends and receives
  call MPI_Recv_init(receiveBuffer, size, MPI_INTEGER, source, 0, MPI_COMM_WORLD, requests(2), rc)
  call MPI_Send_init(message, size, MPI_INTEGER, destination, 0, MPI_COMM_WORLD, requests(1), rc)
